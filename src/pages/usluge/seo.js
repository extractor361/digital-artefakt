...
function ServiceDetailsPage() {
  ...
  <meta name="twitter:image" content="/assets/img/logo.png" />
      ...
      <Breadcrumb
        pageList="Optimizacija za pretraživače"
        title="Profesionalna optimizacija za pretraživače"
        pageName="SEO"
      />
...
Detaljna analiza ključnih riječi i konkurencije                    </li>
                    <li>
                      <svg
                        width={15}
                        height={15}
...
On-page SEO – optimizacija sajta                   </li>
                    <li>
                      <svg
                        width={15}
                        height={15}
...
Off-page SEO – izgradnja domen autoriteta                  </li>
                    <li>
                      <svg
                        width={15}
                        height={15}
...
Kreiranje i optimizacija sadržaja                    </li>
                    <li>
                      <svg
                        width={15}
                        height={15}
...
Tehnička SEO optimizacija i sigurnost sajta                    </li>
                    <li>
                      <svg
                        width={15}
                        height={15}
...
Praćenje pozicija i mjesečni izvještaji                </li>
                  </ul>
                </div>
              </div>
              <div
                ...
                >
                  <div className="single-work">
                    ...
                    <div className="work-content">
                      <h3>Upoznavanje i analiza sajta</h3>
                      <p>
Počinjemo razgovorom o tvom biznisu, ciljnoj publici i konkurenciji. Pregledamo trenutno stanje sajta, njegovu poziciju na pretraživačima, tehničku ispravnost i sadržaj. Na osnovu toga postavljamo jasan SEO cilj.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="single-work">
                    ...
                    <div className="work-content">
                      <h3>Istraživanje ključnih riječi i strategija</h3>
                      <p>
Pronalazimo najrelevantnije ključne riječi koje tvoja publika traži na Google-u. Analiziramo konkurenciju i osmišljavamo SEO strategiju koja će tvoju stranicu dovesti na bolje pozicije u rezultatima pretrage.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="single-work">
                    ...
                    <div className="work-content">
                      <h3>On-page optimizacija sajta</h3>
                      <p>
Optimizujemo strukturu sajta, naslove, meta opise, sadržaj, URL-ove, alt tagove i sve druge elemente koji direktno utiču na rangiranje. Fokus je na tehničkoj i sadržajnoj ispravnosti prema SEO pravilima.
                ...
                >
                  <div className="single-work">
                    ...
                    <div className="work-content">
                      <h3>Kreiranje sadržaja i izgradnja infrastrukture web veza</h3>
                      <p>
Pišemo SEO-friendly tekstove koji povećavaju vidljivost sajta. Paralelno radimo na strategiji izgradnje backlinkova, uključujući upise u direktorijume, saradnje i PR tekstove.
                ...
                >
                  <div className="single-work">
                    ...
                    <div className="work-content">
                      <h3>Praćenje rezultata i optimizacija</h3>
                      <p>
Redovno pratimo pozicije sajta, saobraćaj i ponašanje korisnika. Na osnovu podataka vršimo dodatna podešavanja kako bi rezultati konstantno rasli. Dobijaš transparentne mjesečne izvještaje i predloge za dalji rast.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="accordion" id="accordionExample">
            <div className="accordion-item">
              <h6 className="accordion-header" id="headingOne">
                ...
                >
                  Šta uključuje SEO optimizacija sajta?
                </button>
              </h6>
              <div
                id="collapseOne"
              ...
              >
                <div className="accordion-body">
                  SEO uključuje tehničku optimizaciju sajta, optimizaciju sadržaja, istraživanje ključnih riječi, izgradnju linkova, analizu konkurencije i kontinuirano praćenje rezultata. Cilj je bolje pozicioniranje na Google-u i povećan organski saobraćaj.
                </div>
              </div>
            </div>
            ...
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  Rezultati SEO kampanje zavise od konkurencije u industriji i stanja sajta, ali prve pomake je moguće očekivati nakon 1 do 3 mjeseca, dok su stabilni rezultati vidljivi kroz duži vremenski period.
                </div>
              </div>
            </div>
            ...
            <div className="accordion-item">
              <h6 className="accordion-header" id="headingThree">
                ...
                >
                  Da li nudite SEO i za strane jezike i tržišta?
                </button>
              </h6>
              <div
                id="collapseThree"
              ...
              >
                <div className="accordion-body">
                  Da, optimizujemo sajtove za više jezika i različita međunarodna tržišta, uključujući lokalizaciju sadržaja, tehničku SEO pripremu i prilagođavanje ključnih riječi za svaki jezik.
                </div>
              </div>
            </div>
            ...
            <div className="accordion-item">
              <h6 className="accordion-header" id="headingFour">
                ...
                >
                  Da li radite SEO za postojeće sajtove?
                </button>
              </h6>
              <div
                id="collapseFour"
              ...
              >
                <div className="accordion-body">
                  Da, radimo detaljnu SEO analizu postojećih sajtova i optimizujemo tehničke aspekte, sadržaj i strukturu sajta bez potrebe za kompletnim redizajnom.
                </div>
              </div>
            </div>
            ...
            <div className="accordion-item">
              <h6 className="accordion-header" id="headingFive">
                ...
                >
                  Da li pružate izvještaje i analitiku?
                </button>
              </h6>
              <div
                id="collapseFive"
              ...
              >
                <div className="accordion-body">
                  Svaki klijent dobija mjesečne izvještaje sa jasnim podacima o napretku, saobraćaju, pozicijama na pretrazi i preporukama za dalji rast. Sve što radimo je mjerljivo i transparentno.
                </div>
              </div>
            </div>
          </div>
    ...
    <div className="row">
      <div className="col-lg-12">
        <div className="contact-wrapper text-center magnetic-item">
          ...
          <h2 className="content">SEO po mjeri</h2>
