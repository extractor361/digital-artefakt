...
function ServiceDetailsPage() {
  return (
    <Layout>
      <head>
  <meta charset="UTF-8" />
  <title>Izrada Veb Sajta | Profesionalni Veb Dizajn i Razvoj | Digital Artefakt</title>
  <meta name="description" content="Projektujemo i razvijamo moderne, brze i bezbjedne veb sajtove po mjeri. WordPress, custom CMS, optimizacija, SEO i podrška – sve na jednom mjestu." />
  <meta name="keywords" content="izrada sajta, veb dizajn, WordPress sajt, razvoj veb stranice, profesionalni sajt, sigurnost sajta, SEO optimizacija, responsive dizajn, veb agencija Crna Gora" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <link rel="icon" href="/assets/img/logo.png" type="image/png" />

  <meta property="og:title" content="Izrada Veb Sajta | Digital Artefakt" />
  <meta property="og:description" content="Izrada profesionalnih i sigurnih veb sajtova uz tehničku i dizajnersku ekspertizu. Prilagođeni razvoj i CMS rešenja." />
  <meta property="og:image" content="/assets/img/logo.png" />
  <meta property="og:url" content="https://www.digital-artefakt.me/izrada-veb-sajta" />
  <meta property="og:type" content="website" />

  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="Izrada Veb Sajta | Digital Artefakt" />
  <meta name="twitter:description" content="Brzi, sigurni i optimizovani veb sajtovi po vašoj mjeri. WordPress, SEO, dizajn i podrška." />
  <meta name="twitter:image" content="/assets/img/logo.png" />
</head>

      <Breadcrumb
        pageList="Izrada veb sajta"
        title="Profesionalni razvoj veb sajta"
        pageName="Izrada veb sajta"
      />
...
Prilagođeni dizajn za sve uređaje
                    </li>
                    <li>
                      <svg
                        width={15}
...
Optimizacija brzine i sigurnosti
                    </li>
                    <li>
                      <svg
                        width={15}
...
SEO tehnička priprema
 ...
 Integracija sa CMS-om (WordPress ili prilagođeni sistem)                    </li>
                    <li>
                      <svg
                        width={15}
                        height={15}
...
Tehnička podrška i održavanje                    </li>
                  </ul>
                </div>
              </div>
              <div
                ...
                >
                  <div className="single-work">
                    ...
                    <div className="work-content">
                      <h3>Upoznavanje i analiza potreba/</h3>
                      <p>
                        Započinjemo razgovorom o vašem brendu, ciljevima i publici.
Istražujemo šta želite da postignete sa sajtom.
Na osnovu toga planiramo sledeće korake.
                ...
                >
                  <div className="single-work">
                    ...
                    <div className="work-content">
                      <h3>Planiranje i struktura sajta</h3>
                      <p>
  ...
  <div className="accordion" id="accordionExample">
    <div className="accordion-item">
      <h6 className="accordion-header" id="headingOne">
        ...
        >
          Šta obuhvata izrada veb sajta/aplikacije?
        </button>
      </h6>
      <div
        id="collapseOne"
