...
Zaštita sajta od napada i praćenje u realnom vremenu</li>
                    <li>
                      <svg
                        width={15}
                        height={15}
...
Redovno ažuriranje softvera, dodataka i uklanjanje bezbjedonosnih prijetnji                  </li>
                    <li>
                      <svg
                        width={15}
                        height={15}
...
Implementacija i održavanje SSL sertifikata za siguran prenos podataka
...
Zaštita od DDoS i drugih napada koji onemogućavaju rad sajta                 </li>
                    <li>
                      <svg
                        width={15}
                        height={15}
...
Pravljenje sigurnosnih kopija i planovi za oporavak podataka                   </li>
                    <li>
                      <svg
                        width={15}
                        height={15}
...
Otkrivanje i uklanjanje zlonamernih skripti           </li>
                  </ul>
                </div>
              </div>
              <div
          ...
          <div className="accordion" id="accordionExample">
            ...
            <div className="accordion-item">
              <h6 className="accordion-header" id="headingTwo">
                ...
                >
                  Koje vrste napada mogu ugroziti moj sajt?
                </button>
              </h6>
              <div
                id="collapseTwo"
              ...
              >
                <div className="accordion-body">
                  Najčešći napadi uključuju "malware" infekcije, "phishing" pokušaje, "DDoS" napade, SQL injekcije i krađu podataka. Naš tim implementira različite slojeve zaštite kako bi spriječio ove i druge pretnje.
                </div>
              </div>
            </div>
            ...
            <div className="accordion-item">
              <h6 className="accordion-header" id="headingThree">
                ...
                >
                  Kako štitite podatke korisnika na sajtu?
                </button>
              </h6>
              <div
                id="collapseThree"
              ...
              >
                <div className="accordion-body">
                  Koristimo enkripciju, sigurnosne protokole i redovne bezbjedonosne provere kako bismo zaštitili lične i osetljive podatke korisnika od neovlašćenog pristupa i curenja.
                </div>
              </div>
            </div>
            ...
            <div className="accordion-item">
              <h6 className="accordion-header" id="headingFour">
                ...
                >
                  Da li nudite kontinuiranu zaštitu i održavanje?
                </button>
              </h6>
              <div
                id="collapseFour"
              ...
              >
                <div className="accordion-body">
                  Da, nudimo redovno ažuriranje bezbjednosnih mjera, monitoring sajta i brzu reakciju u slučaju sigurnosnih incidenata kako bismo osigurali stabilan i siguran rad vašeg sajta.
                </div>
              </div>
            </div>
            ...
            <div className="accordion-item">
              <h6 className="accordion-header" id="headingFive">
                ...
                >
                  Kako da znam da je moj sajt bezbjedan?
                </button>
              </h6>
              <div
                id="collapseFive"
              ...
              >
                <div className="accordion-body">
                  Nakon implementacije zaštitnih mjera, redovno vršimo bezbjednosne audite i testove penetracije. Takođe, pružamo izveštaje i preporuke za dalja unapređenja sigurnosti sajta.
                </div>
              </div>
            </div>
          </div>
    ...
    <div className="row">
      <div className="col-lg-12">
        <div className="contact-wrapper text-center magnetic-item">
          ...
          <h2 className="content">Zaštitimo WEB</h2>
