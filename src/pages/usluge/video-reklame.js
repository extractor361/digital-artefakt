                ...
                <div className="about-content">
                  ...
                  <p>
                    ...
                    <ul>
                      ...
                      <li>Animirane promo videe i motion graphics</li>
                      <li>Video editing za YouTube, kampanje i korporativne projekte</li>
                      <li>Color grading i finalnu obradu snimaka</li>
                      <li>Sound design i dodavanje efekata</li>
                    </ul>
                  ...
                  <ul className="about-featue">
                    <li>Profesionalna montaža i obrada videa</li>
                    <li>Animacije i motion graphics u After Effects-u</li>
                    <li>Reklamni spotovi za društvene mreže i brendove</li>
                    <li>Boje, zvuk i efekti koji pojačavaju priču</li>
                    <li>Brza isporuka i fleksibilna saradnja</li>
                  </ul>
                </div>
              </div>
