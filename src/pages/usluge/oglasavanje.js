...
function ServiceDetailsPage() {
  ...
  <meta property="og:title" content="Oglašavanje na Google-u i Društvenim Mrežama | Digital Artefakt" />
  <meta property="og:description" content="Efikasne Google i Meta kampanje sa fokusom na rezultate. Više klikova, više upita, više prodaja. Kontaktirajte nas već danas." />
  <meta property="og:image" content="https://www.digital-artefakt.me/assets/img/logo.png" />
  <meta property="og:url" content="https://www.digital-artefakt.me/usluge/oglasavanje" />
  <meta property="og:type" content="website" />

  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="Oglašavanje na Google-u i Društvenim Mrežama | Digital Artefakt" />
  <meta name="twitter:description" content="Stručno vođenje Google i Meta kampanja. Ciljano oglašavanje koje donosi rezultate. Digital Artefakt – Vaš partner za digitalni marketing." />
  ...
  <link rel="canonical" href="https://www.digital-artefakt.me/usluge/oglasavanje" />
      ...
      <Breadcrumb
        pageList="Oglašavanje i reklamne kampanje"
        title="Oglašavanje na pretraživačima i društvenim mrežama"
        pageName="Oglašavanje i reklamne kampanje"
      />
...
Google reklame (pretraga, display, YouTube, remarketing)                    </li>
                    <li>
                      <svg
                        width={15}
                        height={15}
...
Meta reklame (Facebook & Instagram kampanje)                    </li>
                    <li>
                      <svg
                        width={15}
                        height={15}
...
Strateško targetiranje publike                    </li>
                    <li>
                      <svg
                        width={15}
                        height={15}
...
A/B testiranje oglasa i budžeta                 </li>
                    <li>
                      <svg
                        width={15}
                        height={15}
...
Dnevno i mjesečno praćenje performansi                    </li>
                  </ul>
                </div>
              </div>
              <div
        ...
        >
          <div className="single-work">
            ...
            <div className="work-content">
              ...
              <p>
                Upoznajemo vaš biznis, ciljnu publiku i konkurenciju. 
                Zajedno definišemo ciljeve oglašavanja i ključne pokazatelje uspješnosti koje želimo postići.
              </p>
            </div>
          </div>
        </div>
        ...
        >
          <div className="single-work">
            ...
            <div className="work-content">
              ...
              <p>
                Biramo platforme (Google Ads, Facebook, Instagram), definišemo budžet, ciljanje i trajanje kampanje.
                Pripremamo kreativne oglase koji privlače pažnju.
              </p>
            </div>
          </div>
        </div>
        ...
        >
          <div className="single-work">
            ...
            <div className="work-content">
              ...
              <p>
                Postavljamo oglase na odabrane platforme, pravilno pratimo konverzije i optimizujemo početne parametre.
                Kampanje se aktiviraju i kreće praćenje učinka.
              </p>
            </div>
          </div>
        </div>
        ...
        >
          <div className="single-work">
            ...
            <div className="work-content">
              ...
              <p>
                Pratimo rezultate u realnom vremenu, vršimo A/B testiranja, prilagođavamo oglase, budžete i publiku radi boljih rezultata i niže cijene po konverziji.
              </p>
            </div>
          </div>
        </div>
        ...
        >
          <div className="single-work">
            ...
            <div className="work-content">
              ...
              <p>
                Dobijate detaljan mjesečni izvještaj o učinku kampanja. 
                Predlažemo poboljšanja i nove taktike na osnovu rezultata kako biste stalno rasli.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="driscription-content">
        <div className="row">
          ...
          >
            ...
            <p>
              Pružamo sveobuhvatna rješenja za oglašavanje na Google platformama i društvenim mrežama. Naš stručni tim razvija ciljane kampanje koje povećavaju vidljivost vašeg brenda, privlače relevantne kupce i povećavaju povrat uloženih sredstava. Kombinujemo analitiku, kreativni pristup i stalnu optimizaciju kako bismo postigli najbolje rezultate za vaš biznis.
            </p>
          </div>
          <div
            className="col-md-6 wow animate fadeInUp"
          ...
          >
            ...
            <p>
              Svaka kampanja je prilagođena vašim specifičnim ciljevima i publici. Koristimo napredne alate za praćenje i analizu podataka kako bismo kontinuirano optimizovali oglase. Fokusiramo se na jasno definisane ciljeve koji prate stvarne poslovne rezultate i rast vašeg brenda.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="accordion" id="accordionExample">
            <div className="accordion-item">
              <h6 className="accordion-header" id="headingOne">
                ...
                >
                  Šta obuhvata usluga oglašavanja na Google-u i društvenim mrežama?
                </button>
              </h6>
              <div
                id="collapseOne"
              ...
              >
                <div className="accordion-body">
                  Usluga uključuje izradu i upravljanje kampanjama na Google Ads i platformama društvenih mreža poput Facebooka, Instagrama i LinkedIna. Kreiramo oglase, postavljamo ciljanje, optimizujemo budžet i pratimo performanse kako bismo povećali vašu vidljivost i broj konverzija.
                </div>
              </div>
            </div>
            <div className="accordion-item">
              <h6 className="accordion-header" id="headingTwo">
                ...
                >
                  Kako odrediti budžet za kampanju?
                </button>
              </h6>
              <div
                id="collapseTwo"
              ...
              >
                <div className="accordion-body">
                  Budžet zavisi od ciljeva kampanje, konkurencije i veličine ciljne publike. Na osnovu analize pravimo preporuke koje su optimalne za vaš biznis, a budžet možemo prilagođavati tokom trajanja kampanje.
                </div>
              </div>
            </div>
            <div className="accordion-item">
              <h6 className="accordion-header" id="headingThree">
                ...
                >
                  Koje su ključne metrike uspeha kampanje?
                </button>
              </h6>
              <div
                id="collapseThree"
              ...
              >
                <div className="accordion-body">
                  Pratimo KPI-jeve poput broja klikova, stope konverzije, cijene po kliku (CPC), povrata ulaganja (ROAS) i angažmana publike kako bismo procijenili i poboljšali učinak kampanja.
                </div>
              </div>
            </div>
            <div className="accordion-item">
              <h6 className="accordion-header" id="headingFour">
                ...
                >
                  Koliko traje postavljanje i optimizacija kampanje?
                </button>
              </h6>
              <div
                id="collapseFour"
              ...
              >
                <div className="accordion-body">
                  Priprema kampanje obično traje od nekoliko dana do sedmice, dok je optimizacija kontinuirani proces tokom cijelog trajanja oglašavanja.
                </div>
              </div>
            </div>
            <div className="accordion-item">
              <h6 className="accordion-header" id="headingFive">
                ...
                >
                  Da li nudite podršku tokom trajanja kampanje?
                </button>
              </h6>
              <div
                id="collapseFive"
              ...
              >
                <div className="accordion-body">
                  Da, pružamo stalnu podršku, redovne izveštaje i preporuke za unapređenje kako bismo osigurali da kampanja ostvaruje najbolje moguće rezultate.
                </div>
              </div>
            </div>
          </div>
    ...
    <div className="row">
      <div className="col-lg-12">
        <div className="contact-wrapper text-center magnetic-item">
          ...
          <h2 className="content">Digitalno oglašavanje</h2>
