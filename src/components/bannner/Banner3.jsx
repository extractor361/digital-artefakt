        ...
        <Swiper {...slider} className="swiper banner3-slider">
            ...
            <SwiperSlide className="swiper-slide">
                ...
                <div className="banner-content">
                    <h1>Jedinstvena softverska rješenja.</h1>
...
Nudimo vam profesionalnu izradu veb sajtova i aplikacija, portala i internet prodavnica.</p>
            ...
            <SwiperSlide className="swiper-slide">
                <div className="banner-wrapper">
                <div className="banner-content">
                    <h1>Digitalna rješenja za vaš biznis.</h1>
                    <p>
Tražite rješenja koja će vaš biznis podići na viši nivo? Naša ponuda obuhvata sve što vam je potrebno - od izrade profesionalnih web sajtova i mobilnih aplikacija do precizno usmjerenih web  kampanja. Uložite u rast vašeg poslovanja, dok mi brinemo o svim aspektima vaše prisutnosti u digitalnom etru.</p>
                    <div className="banner-btn-group">
                    <Link legacyBehavior href="/kontakt"><a className="primary-btn3">Besplatne konsultacije</a></Link>
                    <Link legacyBehavior href="/onama">
                        <a className="primary-btn4">
